...
def echo(update, context):
	...
	reply_message = 'This is the health chatbot sevice, you can use the commands among "help", "eat", "report" and "weight" to achieve some function.'
